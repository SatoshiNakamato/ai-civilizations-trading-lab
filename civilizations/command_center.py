...
def main():
    ...
    print('AEON COMMAND CENTER ONLINE'); print('Type commands at the CREATOR> prompt. `run` defaults to one life tick.'); print('Try: status | run | run 10 | inspect A017 | speak hello | shutdown')
